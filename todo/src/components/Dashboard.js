...
export default function Dashboard() {
  return (
      ...
      <div className="flex flex-col gap-5 w-full max-w-screen-xl mx-auto ml-[272px] mt-[104px] mb-6">
        <Banner />
        <div className="flex flex-col gap-5 md:flex-row items-start">
          ...
          <div className="flex flex-col gap-3 md:mr-12 items-start w-full md:w-1/3 mr-6">
            <ActivityFeed />
            <TaskPrior />
          </div>
        </div>
